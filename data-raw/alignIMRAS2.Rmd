...
```{r echo=TRUE, message=FALSE, warning=TRUE, cache=TRUE}
...
pheno <- fread(paste0(outDir, "/kallisto_Pheno.csv"), sep=",", header=TRUE,
               data.table=FALSE)
counts <- fread(paste0(outDir, "/kallisto_counts.csv"), sep=",", header=TRUE,
                data.table=FALSE)
tpm <- fread(paste0(outDir, "/kallisto_tpms.csv"), sep=",", header=TRUE,
             data.table=FALSE)
